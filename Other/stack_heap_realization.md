...
Структура данных в программировании, с помощью которой реализованна динамичкеески распределяемая память приложения.
...
В куче может произойти слияние элементов, эта опперация ускорит нахождение элементов в куче.
