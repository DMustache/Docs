...
Следующий принцип используется как раз для того, чтобы дать возможность использовать любой тип, который является наследником родителя. Этот принцип называют полиморфизмом.
