...
Трейт `Drop` имеет только один метод: `drop`Ю который вызывается автоматически, когда объект выходит за границы области видимости. Основное использование трейта `Drop` - освобождение ресурсов после использования:
